    ...
    return (
        <div className="container">
            ...
            <div className="resumen-dia">
                ...
                <h1 className={
                    totalVentas - totalGastos > 0 ? "positivo" : "negativo"
                }>
                        ...
                        {ventasFiltradas.length === 0 ? (
                            ...
                            <div className="lista">
                                {[...ventasFiltradas]
                                    ...
                                    .map((v) => (
                                        <div className="item-row venta" key={v.id}>
                        ...
                        {gastosFiltrados.length === 0 ? (
                            ...
                            <div className="lista">
                                {[...gastosFiltrados]
                                    .sort((a, b) => b.timestamp - a.timestamp)
                                    .map((g) => (
                                        <div className="item-row gasto" key={g.id}>
                                            <span className="producto">{g.descripcion}</span>
                                            <span className="detalle">-</span>
                                            <span className="total">${g.monto}</span>
                                        </div>
                                    ))}
                            </div>
                        )}
                ...
                <div className="insights">
                    ...
                    <div className="insights-grid">
                        ...
                        <div className="insight-card">
                            ...
                            <strong>
                                {topProducto ? `${topProducto[0]} (${topProducto[1]})` : "-"}
                            </strong>
                        </div>
                        ...
                        <div className="insight-card">
                            <span>📈 Mejor día</span>
                            <strong>
                                {mejorDia ? `${mejorDia[0]} ($${mejorDia[1]})` : "-"}
                            </strong>
                        </div>

                        <div className="insight-card">
                            <span>📊 Promedio diario</span>
                            <strong>${Math.round(promedioDiario)}</strong>
                        </div>

                        <div className="insight-card">
                            <span>🍕 Promedio venta</span>
                            <strong>{promedioPorVenta.toFixed(1)}</strong>
                        </div>
